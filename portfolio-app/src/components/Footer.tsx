...
const socialLinks = [
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/andika-firmansyah-475a8638b/",
    icon: (
  ...
  {
    name: "GitHub",
    href: "https://github.com/andikafn",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Email",
    href: "mailto:andikafirmansyahnugraha4@gmail.com",
    icon: (
      <svg
        className="h-5 w-5"
        fill="none"
      ...
      <div className="container-custom relative z-10">
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          <p className="text-sm text-white/55">
            © {new Date().getFullYear()} Andika Firmansyah Nugraha
          </p>
